...
Система учета принтерных картриджей
 ![Пример окна программы](/pic1.JPG)
...
4. В справочнике операций проверить наличие 9 строк с названиями операций (если их нет, то выполнить init.sql или внести вручную)   
...
Если картриджу установить статус **"Дефект"**, то в столбце действий появится кнопка **"Списание"**. При нажатии на нее и указании причины списания, статус картриджа поменяется на **"Списан"** и он исчезнет из списка. Также можно дефектный картридж отправить заправщику на восстановление/ремонт.

Пункт меню **"Отчеты"** позволяет проанализировать движение/расход картриджей, списки списанных и возвращенных, а так же лог действий по конкретному экземпляру. 
